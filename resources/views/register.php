                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 box">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input name="idmark-1" id="idmark-1" type="text" class="form-control form-control-sm" placeholder="Enter your Identification Mark - 1">
                                    <br>
                                    <input name="idmark-2" id="idmark-2" type="text" class="form-control form-control-sm" placeholder="Enter your Identification Mark - 2">
                                </div>
                            </div>
                        </div>
                        <br>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="ss-course" id="ss-course" class="form-control form-control-sm">
                            ...
                            <div class="form-group">
                                ...
                                <input name="ss-insti" id="ss-insti" type="text" class="form-control form-control-sm" placeholder="Enter Institution Name">
                            </div>
                            <div class="form-group">
                                <label>Board of Study</label>
                                <input name="ss-board" id="ss-board" type="text" class="form-control form-control-sm" placeholder="Enter Board of Study">
                            </div>
                            <div class="form-group">
                                <label>Year of Passing</label>
                                <input name="ss-pass" id="ss-pass" type="number" class="form-control form-control-sm" value="2021" placeholder="Enter the year of Passing">
                            </div>
                            <div class="form-group">
                                <label>Marks or CGPA</label>
                                <input name="ss-cgpa" id="ss-cgpa" type="number" class="form-control form-control-sm" placeholder="Enter your CGPA/Marks">
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input name= "kin-Relationship" id="kin-Relationship" type="text" class="form-control form-control-sm" placeholder="Enter your relationship with Kin">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                                <input name="kin-address" id="kin-address" type="text" class="form-control form-control-sm" placeholder="Enter their address">
                            </div>
                            <div class="form-group">
                                <label>Telephone No. (O)/(R) (as applicable)</label>
                                <input name="kin-telephone" id="kin-telephone" type="text" class="form-control form-control-sm" placeholder="Enter Telephone No.">
                            </div>
                        </div>
                    </div>
                    <br>
