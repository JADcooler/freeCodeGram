...
body {
  ...
  color: #212529;
  text-align: left;
  background-color: rgb(81, 139, 187);
}
    ...
    @csrf
        <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 box">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input id="nationality" type="text" class="form-control form-control-sm" placeholder="Enter your Nationality">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 box">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input id="blood" type="text" class="form-control form-control-sm" placeholder="Enter your Blood Group">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 box">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input id="mark-1" type="text" class="form-control form-control-sm" placeholder="Enter your Identification Mark - 1">
                                    <br>
                                    <input id="mark-2" type="text" class="form-control form-control-sm" placeholder="Enter your Identification Mark - 2">
                                </div>
                            </div>
                        </div>
                        <br>
                            <div class="col-md-4 box">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input id="qualification" type="text" class="form-control form-control-sm" placeholder="Enter your Education Qualification">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 box">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input id="qualifications_per" type="text" class="form-control form-control-sm" placeholder="Enter your Marks in (%)">
                                    </div>
                                </div>
                            </div>
                    </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <textarea id="crime" class="form-control form-control-sm"></textarea>
                </div>
                <div class="card-body">
                    <div class="form-group">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <textarea id="willness" class="form-control form-control-sm"></textarea>
                </div>
            </div>
            <br>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <textarea id="NCC Unit" class="form-control form-control-sm"></textarea>
                </div>
            </div>
            <br>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <textarea id="dismissed" class="form-control form-control-sm"></textarea>
                </div>
            </div>
            <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="kin-Relationship" type="text" class="form-control form-control-sm" placeholder="Enter your relationship with Kin">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                                <input id="kin-address" type="text" class="form-control form-control-sm" placeholder="Enter their address">
                            </div>
                            <div class="form-group">
                                <label>Telephone No. (O)/(R) (as applicable)</label>
                                <input id="kin-telephone" type="text" class="form-control form-control-sm" placeholder="Enter Telephone No.">
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="IFSC code:" type="text" class="form-control form-control-sm" placeholder="Enter your IFSC code:">
                            </div>
                            <div class="form-group">
                                <label>Bank Acct No of Cadet/Parent</label>
                                <input id="Bank Acct" type="text" class="form-control form-control-sm" placeholder="Enter Bank Acct No of Cadet/Parent">
                            </div>
                            <div class="form-group">
                                <label>Aadhaar/UID No. (If allotted)</label>
                                <input id="Aadhar No" type="text" class="form-control form-control-sm" placeholder="Enter Aadhar NO.">
                            </div>
                            <div class="form-group">
                                <label>PAN Card No. (If allotted)</label>
                                <input id="PAN No" type="text" class="form-control form-control-sm" placeholder="Enter PAN NO.">
                            </div>
                        </div>
                    </div>
                    <br>
            ...
            $.ajax({
                ...
                success:function(data) {
                    if (data != "fail") {
                        ...
                        _("progress").innerHTML = "<a class='btn btn-success' target='_blank' href='<?php echo 'pepe' ?>index.php/viewPDF/"+data+"'>Link To View and Download</a>";
                    } else {
                        _("failed").style.display = "block";
                    }
